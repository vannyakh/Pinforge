...
const SystemSettings: React.FC = () => {
  ...
  /** Tool binary paths / onboard preview are for unpackaged (dev) builds only. */
  ...
  useEffect(() => {
    void loadYtdlp();
  }, [loadYtdlp, settings?.system?.ytdlpPath, settings?.system?.ytdlpEnabled]);
      ...
      <div className="bg-2 rd-12px border border-b-base px-18px mb-28px">
        <div className="py-14px border-b border-b-base">
          ...
          {ffStatus?.version && (
            <div
              ...
              title={showDevDetails ? ffStatus.path : undefined}
            >
              {ffStatus.version}
              {showDevDetails && ffStatus.path ? ` · ${ffStatus.path}` : ""}
            </div>
          )}
        ...
        <div className="py-14px border-b border-b-base">
          ...
          {ytStatus?.version && (
            <div
              className="text-12px text-t-secondary mb-10px truncate"
              title={showDevDetails ? ytStatus.path : undefined}
            >
              {ytStatus.version}
              {showDevDetails && ytStatus.path ? ` · ${ytStatus.path}` : ""}
            </div>
          )}
        ...
        <div className="py-14px border-b border-b-base">
          <div className="flex items-start justify-between gap-16px mb-10px">
            <div className="min-w-0">
              ...
              <div className="text-12px text-t-tertiary mt-4px leading-relaxed">
                Browser used to scrape Instagram, TikTok, Facebook, and Pinterest when page meta is
                missing.
              </div>
            </div>
          ...
          {pwStatus?.version && (
            <div
              className="text-12px text-t-secondary mb-10px truncate"
              title={showDevDetails ? pwStatus.path : undefined}
            >
              {showDevDetails
